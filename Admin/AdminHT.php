...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="nav nav-pills me-auto mb-2 mb-lg-0" style="margin-left:20%">
                    ...
                    <li class="nav-item px-3">
                        <a class="nav-link active" href="./AdminHT.html">Health and Train</a>
                    </li>
                    <li class="nav-item px-3">
  ...
  top: 30%;">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    $image = !empty($row['photo']) ? "../assets/professionals/vets/" . $row['photo'] : "https://via.placeholder.com/50.png/09f/666";
