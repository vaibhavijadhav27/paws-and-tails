    ...
    ?>
            <div class="wrap container-md">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    $image = !empty($row['photo']) ? "../assets/requests/foster/" . $row['photo'] : "https://via.placeholder.com/50.png/09f/666";
                ?>
                        ...
                        <div class="row g-0">
                            <div class="col-md-4">
                                ...
                                <div class="row g-0 m-4">
                                    <a class="btn btn-success" href='<?php echo 'AdminAcceptDog.php?id=' . $row['dreq_id'] . '&type=' . $type ?>'>Accept</a>
                                    <a class="btn btn-danger" href='<?php echo 'AdminRejectDog.php?id=' . $row['dreq_id'] . '&type=' . $type; ?>' onclick="return confirm('Are you sure you want to reject this request?')" ;>Reject</a>
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Payment: <?php echo $row['price'] ?></p>
