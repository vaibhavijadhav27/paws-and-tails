...
<body>
        ...
        ?>
          ...
          <div class="card" style="width: 15em;">
            ...
            <div class="card__inner d-grid">
              ...
              <a class=" btn btn-outline-light btn-block" style="height: 50px;" href='<?php echo 'AdminWalkerForm.php?id=' . $row['p_id']; ?>'><b>Edit</b></a>
  ...
  <div class="position-fixed bottom-0 end-0 m-4 bg-light">
    <button class="btn btn-outline-secondary p-2" onclick="location.href = './AdminWalkerForm.php'">Add
      New
      Professional</button>
  </div>
  <div class="navy col-md-1 m-4 bg-light" style="border: 1px solid gray; border-radius: 5px;">
    <nav class="nav-pills flex-column">
      ...
      <a class="nav-link active" href="./AdminWalker.php">Walkers</a>
