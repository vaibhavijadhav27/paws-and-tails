    ...
    <div class="container-lg">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-start">
        <input class="btn btn-light btn-sm round" onclick="location.href = 'AdminVetForm.html'" type="reset"
          value="&nbsp;Vets&nbsp;" />
        <input class="btn btn-secondary btn-md round" onclick="location.href = 'AdminTrainerForm.html'" type="reset"
          value="Trainers" />
        <input class="btn btn-light btn-sm round" onclick="location.href = 'AdminWalkerForm.html'" type="reset"
          value="Walkers" />
      ...
      <div class="row justify-content-center my-5">
        <div class="col-lg-6">
          ...
          <form action="./AdminAddProductForm.php" method="post">
            <label for="dogname" class="form-label">Name of the Trainer:</label>
            <div class="mb-4 input-group">
              <span class="input-group-text">
                <i class="bi bi-person-fill text-secondary"></i>
              </span>
              <input type="text" id="name" name="name" class="form-control" placeholder="e.g. Tanmay Jadhav" />
            </div>
            ...
            <div class="mb-4 input-group">
              ...
              <input class="form-control" type="text" id="age" name="age" pattern="\d+" placeholder="e.g. 27 years" />
            </div>
        ...
        <div class="col-lg-6">
          ...
          <div class="mb-4 input-group">
            ...
            <input class="form-control" type="text" id="fee" name="fee" pattern="\d+" placeholder="e.g. &#8377;12000" />
          </div>
        ...
        <div class="mb-4 text-center">
          <button type="submit" class="btn btn-secondary" onclick="location.href = './AdminVetForm.html'">Add
            Trainer</button>
        </div>
