    ...
    <div class="container-lg">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-start">
        ...
        <input class="btn btn-light btn-sm round" onclick="location.href = 'AdminWalkerForm.html'" type="reset"
          value="Walkers" />
        <input class="btn btn-secondary btn-md round" onclick="location.href = 'AdminCaretakerForm.html'" type="reset"
          value="Care Takers" />
      </div>
      ...
      <div class="row justify-content-center my-5">
        <div class="col-lg-6">
          <form action="./AdminAddProductForm.php" method="post">
            <label for="dogname" class="form-label">Name of the Caretaker:</label>
            <div class="mb-4 input-group">
              <span class="input-group-text">
                <i class="bi bi-person-fill text-secondary"></i>
              </span>
              <input type="text" id="name" name="name" class="form-control" placeholder="e.g. Amit Shaikh" />
            </div>
            ...
            <div class="mb-4 input-group">
              ...
              <input class="form-control" type="text" id="age" name="age" pattern="\d+" placeholder="e.g. 35 years" />
            </div>
        ...
        <div class="mb-4 text-center">
          <button type="submit" class="btn btn-secondary">Add Caretaker</button>
        </div>
        </form>
      </div>
    </div>
