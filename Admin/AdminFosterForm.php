  ...
  if (empty($name)) {
    ...
    if (in_array($fileType, $allowTypes)) {
      ...
      if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFilePath)) {
        ...
        $sql = "INSERT INTO `dog` (`name`, `breed`, `age`, `gender`,`type`, `photo`,`description`,`price`) VALUES ('$name','$breed', '$age', '$gender','$type', '" . $fileName . "','$desc','$price')";
...
<body>
  ...
  if ($showAlert == true) {
    echo ' <div class="alert alert-success alert-dismissible fade show" role="alert">
        <strong>Success!</strong> New dog added to foster section!
        ...
        <div class="col-lg-6">
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-4 input-group">
              ...
              <input type="text" id="name" name="name" class="form-control" placeholder="e.g. Bubble" />
            </div>
            ...
            <div class="mb-4 input-group">
              ...
              <input type="text" id="breed" name="breed" class="form-control" placeholder="e.g. Beagle" />
            </div>
            ...
            <div class="mb-4 input-group">
              ...
              <input class="form-control" type="text" id="age" name="age" placeholder="e.g. 3 years" />
            </div>
