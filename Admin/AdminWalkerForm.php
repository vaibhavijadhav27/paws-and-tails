  ...
  if (empty($name)) {
    ...
    if (!empty($photo['name'])) {
      ...
      if (in_array($fileExtension, $allowed)) {
        $uploadFileDir = $productR['check'] == 'request' ? "../assets/requests/walker/" : "../assets/professionals/walkers/";
  ...
  <section id="contact">
    <div class="container-lg">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-start">
        ...
        <input class="btn btn-secondary btn-md round" onclick="location.href = 'AdminWalkerForm.php'" type="reset" value="Walkers" />
      ...
      <div class="row justify-content-center my-5">
        <div class="col-lg-6">
          ...
          <form action="" method="post" enctype="multipart/form-data">
            <label for="name" class="form-label">Name of the Walker:</label>
            <div class="mb-4 input-group">
              <span class="input-group-text">
                <i class="bi bi-person-fill text-secondary"></i>
              </span>
              <input type="text" id="name" name="name" value="<?php echo $productName ?>" class="form-control" placeholder="e.g. Ram Sundar" />
            </div>
        ...
        <div class="mb-4 text-center">
          ...
          <button type="submit" class="btn btn-secondary" onclick="location:'./AdminWalkerForm.php'">Add
            Walker
          </button>
        </div>
