                        ...
                        <div class="container" id="profile">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-8 " style="padding-left:20%">
                                    ...
                                    <a class=" btn btn-danger" href='<?php echo 'AdminDeleteProfessional.php?id=' . $productID . '&type=' . $type; ?>' onclick=" return confirm('Are you sure you want to delete this product?');"><b>Delete</b></a>
                                </div>
                            </div>
