        ...
        <div class="col-lg-6">
          ...
          <form action="./signup.php" method="post">
            ...
            <div class="mb-4 input-group">
              ...
              <input required type="text" id="name" name="name" class="form-control" placeholder="Firstname Surname "
                pattern="[a-zA-Z]+ [a-zA-Z]+$"
                oninvalid="setCustomValidity('Please enter alphabets only and match the requested format. ')" />
            </div>
            ...
            <div class="input-group mb-4">
              ...
              <input required type="text" id="email" name="email" class="form-control" placeholder="e.g. email@example.com"
