...
<body>
    ...
    <div class="container py-5 mt-5 mb-5">
        ...
        $cartAll = "SELECT * from `cart` WHERE user_id='$userid'";
        $result = mysqli_query($conn, $cartAll);
                                ...
                                <div class="border border-gainsboro p-3 mt-3 clearfix item">
                                    ...
                                    <div class="col-lg-5 col-5 text-lg-left">
                                        <h3 class="h6 mb-0">Product: <?php echo $product['name'] ?><br>
                                            ...
                                            <small>cost: <?php echo $product['price']; ?> each</small>
                                        </h3>
                                    </div>
                                    <div class="product-price d-none"><?php echo $product['price']; ?></div>
                                    ...
                                    <div class="col-lg-2 col-md-1 col-sm-2 product-line-price pt-4">
                                        <span class="product-line-price"><?php echo $product['price']; ?>
                                        </span>
                                    </div>
