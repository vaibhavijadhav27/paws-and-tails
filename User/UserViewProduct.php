            ...
            <div class="col-md-8 mt-5">
                <div class="card">
                    <header class="card-header">
                        ...
                        <h4 class="card-title mt-2">Product Detail<i class="bi bi-x text-secondary mb-2" style="font-size:40px; cursor:pointer; float: right; text-shadow:none;" onclick="history.go(-1);"></i></h4>
                    </header>
