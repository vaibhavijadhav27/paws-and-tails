...
<body>
    ...
    <nav class="navbar navbar-expand-sm navbar-light bg-light" style="height: 10%;">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <form class="d-flex" method="post" action="../Admin/AdminSearchProfessional.php">
                ...
                <ul class="nav nav-pills me-auto mb-2 mb-lg-0" style="margin-left:20%">
                    ...
                    <li class="nav-item px-3">
                        <a class="nav-link active" href="./UserHT.php">Health and Train</a>
                    </li>
                    <li class="nav-item px-3">
    ...
    $type = 'trainer';
    $psql = "select * from `professionals` where type='trainer' order by p_id DESC";
  ...
  top: 30%;">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                if ($row['check'] == "request") {
                    ...
                    $image = !empty($row['photo']) ? "../assets/professionals/trainers/" . $row['photo'] : "https://via.placeholder.com/150";
                }
            ?>
                ...
                <div class="card" style="width: 15em;">
                    ...
                    <div class="card__inner d-grid">
                        ...
                        <a class="btn btn-outline-light btn-block" style="height: 50px; margin-top:90%" href='<?php echo 'UserViewProfessional.php?id=' . $row['p_id']; ?>'><b>View</b></a>
                        <a class=" btn btn-outline-light btn-block" style="height: 50px;" href='<?php echo 'AddToCart.php?p_id=' . $row['p_id']; ?>'><b>Add to Cart</b></a>
    ...
    <div class="position-fixed bottom-0 end-0 m-4 bg-light">
        <button class="btn btn-outline-secondary p-2" onclick="location.href = './JobRequestForm.php'">Want to work
            with us?
            Apply here!</button>
    </div>
    <div class="navy col-md-1 m-4 bg-light" style="border: 1px solid gray; border-radius: 5px;">
        <nav class="nav-pills flex-column">
            <a class="nav-link " aria-current="page" href="./UserHT.php">Vets</a>
            <a class="nav-link active" href="./UserTrainer.php">Trainers</a>
            <a class="nav-link " href="./UserWalker.php">Walkers</a>
            <a class="nav-link" href="./UserCaretaker.php">Caretakers</a>
