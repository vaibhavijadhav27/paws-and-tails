...
<body>
  ...
  top: 30%;">
    ...
    <div class="position-fixed bottom-0 end-0 m-4 bg-light">
        <button class="btn btn-outline-secondary p-2" onclick="location.href = './FosterForm.php'">Request to put dog
            for adoption/foster
            New
            Dog</button>
    </div>
    <div class="navy col-md-1 m-4 bg-light" style="border: 1px solid gray; border-radius: 5px;">
        <nav class="nav-pills flex-column">
            ...
            <a class="nav-link " href="UserAdopt.php">Adopt</a>
            <a class="nav-link active" href="UserFoster.php">Foster</a>
        </nav>
    </div>
