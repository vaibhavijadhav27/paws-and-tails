...
<body>
    ...
    $psql = "select * from `professionals` where type='vet' order by p_id DESC";
  ...
  top: 30%;">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                if ($row['check'] == "request") {
                    ...
                    $image = !empty($row['photo']) ? "../assets/professionals/vets/" . $row['photo'] : "https://via.placeholder.com/150";
                }
    ...
    <div class="navy col-md-1 m-4 bg-light" style="border: 1px solid gray; border-radius: 5px;">
        <nav class="nav-pills flex-column">
            <a class="nav-link active" aria-current="page" href="./UserHT.php">Vets</a>
