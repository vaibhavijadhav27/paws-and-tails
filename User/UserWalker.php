...
<body>
    ...
    $type = 'walker';
    $psql = "select * from `professionals` where type='walker' order by p_id DESC";
  ...
  top: 30%;">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                if ($row['check'] == "request") {
                    ...
                    $image = !empty($row['photo']) ? "../assets/professionals/walkers/" . $row['photo'] : "https://via.placeholder.com/150";
                }
    ...
    <div class="navy col-md-1 m-4 bg-light" style="border: 1px solid gray; border-radius: 5px;">
        <nav class="nav-pills flex-column">
            ...
            <a class="nav-link " href="./UserTrainer.php">Trainers</a>
            <a class="nav-link active" href="./UserWalker.php">Walkers</a>
