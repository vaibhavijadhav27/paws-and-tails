...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($userid)) {
        if (!empty($photoName)) {
            ...
            $sql = "UPDATE `user` SET name = '{$name}', email = '{$email}', phone = '{$phone}', address = '{$address}',  profile='{$photoName}' WHERE user_id = {$userid}";
            $message = 'Profile Updated';
        } else {
            $sql = "UPDATE `user` SET name = '{$name}', email = '{$email}', phone = '{$phone}', address = '{$address}' WHERE user_id = {$userid}";
            $message = 'Profile Updated';
        }
        ...
        <div class="container-lg">
            ...
            <div class="row justify-content-center my-5">
                <div class="col-lg-6">
                    ...
                    <form action="./UserEditProfile.php" method="post" enctype="multipart/form-data">
